          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-600 font-medium">Premium RCC Solutions</p>
              </div>
            </div>
          ...
          <div className="fixed top-0 right-0 h-full w-80 bg-white z-50 lg:hidden shadow-2xl animate-slideIn">
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="space-y-3 mb-6 bg-amber-50 p-4 rounded-xl">
                <a href="tel:+919876543210" className="flex items-center space-x-3 text-gray-700 hover:text-amber-700 transition-colors">
                ...
                <a href="mailto:info@usmantanks.com" className="flex items-center space-x-3 text-gray-700 hover:text-amber-700 transition-colors">
                  <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
                    <Mail className="text-amber-600 w-5 h-5" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Email Us</p>
                    <span className="font-medium text-sm">info@usmantanks.com</span>
                  </div>
                </a>
              </div>
