...
const TankSelectionGuide = () => {
  ...
  const products = [
    {
      ...
      capacity: "1000 L",
      description:
        "Perfect for small families (4-5 members). Ideal for residential homes.",
      size: "4×4 ft",
      features: [
        "4-5 people",
        "1-day install",
    ...
    },
    {
      ...
      capacity: "2000 L",
      description:
        "Medium capacity for joint families or small commercial use.",
      size: "8×3 ft",
      features: [
        "6-8 people",
        "2-day install",
    ...
    },
    {
      ...
      capacity: "800 L",
      description:
        "Compact design for small families or as additional backup tank.",
      size: "4×3 ft",
      features: [
        "Compact",
        "Quick install",
    ...
    },
    {
      ...
      capacity: "1200 L",
      description:
        "Heavy duty version with reinforced construction for commercial use.",
      size: "4×4 ft",
      features: [
        "Commercial grade",
        "Extra strong",
    ...
    },
    {
      ...
      capacity: "2500 L",
      description:
        "Industrial grade for factories, workshops and medium commercial use.",
      size: "8×3 ft",
      features: [
        "Industrial grade",
        "3-day install",
  ...
  return (
    <div className=" min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
      {/* Page Header - Added Back to Home and Top Padding */}
      <div
        ref={sectionRef}
                  ...
                  <div className="relative mb-6 flex justify-center">
                    <div className="relative">
                      ...
                      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-4 border-amber-50">
                        <div
                          className={`text-transparent bg-gradient-to-br ${useCase.color} bg-clip-text`}
                        >
                          {useCase.icon}
                        </div>
                      </div>
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-4 mb-6">
                      ...
                      <div className="flex flex-wrap justify-center gap-2">
                        {useCase.sizes.map((size, idx) => (
                          <span
                            key={idx}
                            className="bg-white text-gray-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm border border-amber-200"
                          >
                            {size}
                          </span>
                        ))}
                    ...
                    <div className="space-y-2 mb-4">
                      {product.features.map((feature, featureIndex) => (
                        <div
                          ...
                          style={{
                            transitionDelay: `${
                              getStaggerDelay(featureIndex) + 300
                            }ms`,
                          }}
                          className={`flex items-center space-x-2 transition-all duration-500 ${
                            isVisible
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              ...
              >
                <div className="relative mb-6 flex justify-center">
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${advantage.color} rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    <div className="text-white">{advantage.icon}</div>
                  </div>
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${advantage.color} rounded-full blur-xl opacity-20 group-hover:opacity-40 transition-opacity`}
                  ></div>
                </div>
